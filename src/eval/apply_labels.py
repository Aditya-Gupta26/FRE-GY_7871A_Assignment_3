...
Both approaches produce the identical output schema (url, title, relevant_gold). This
module is kept as the reusable, documented entry point for re-labeling a future sample.
"""
import sys
